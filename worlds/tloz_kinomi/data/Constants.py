...
COLLECT_TOUCH_ONEHAND = TREASURE_SPAWN_INSTANT | TREASURE_GRAB_ONE_HAND | TREASURE_SET_ITEM_ROOM_FLAG
COLLECT_POOF_ONEHAND = TREASURE_SPAWN_POOF | TREASURE_GRAB_ONE_HAND | TREASURE_SET_ITEM_ROOM_FLAG
